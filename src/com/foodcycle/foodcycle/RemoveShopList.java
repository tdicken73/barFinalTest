...
public class RemoveShopList extends FragmentActivity {
				...
				new View.OnClickListener()
				{
					public void onClick(View view)
					{
						if ((isEmpty(mEdit1) == false) && (isEmpty(mEdit2) == false)) {
							...
							food = db.getFoodSL(entry);
							
							Log.d("FOOD SET", food.toString());
							db.deleteFoodSL(food);
...
//							}
	...
	public class GetContacts extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			...
			pDialog = new ProgressDialog(RemoveShopList.this);
